...
#define PLAYER_HEALTH_FRAME {.origin = {.x = 50, .y = 90}, .size = {.w = BATTLE_FRAME_HEALTH_WIDTH, .h = BATTLE_FRAME_HEIGHT}}
#define PLAYER_TIME_FRAME  {.origin = {.x = 67, .y = 90}, .size = {.w = BATTLE_FRAME_TIME_WIDTH, .h = BATTLE_FRAME_HEIGHT}}
#define MONSTER_HEALTH_FRAME {.origin = {.x = 50, .y = 48}, .size = {.w = BATTLE_FRAME_HEALTH_WIDTH, .h = BATTLE_FRAME_HEIGHT}}
#define MONSTER_TIME_FRAME {.origin = {.x = 67, .y = 48}, .size = {.w = BATTLE_FRAME_TIME_WIDTH, .h = BATTLE_FRAME_HEIGHT}}
...
#define BATTLE_FRAME_HEALTH_WIDTH 16
#define BATTLE_FRAME_TIME_WIDTH 8
#define BATTLE_FRAME_TIME_X ((SCREEN_WIDTH / 2 - MAIN_IMAGE_DIMENSION / 2) - (BATTLE_FRAME_TIME_WIDTH + 2))
